    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑贷款项目表</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑贷款项目表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">贷款项目表信息</h3>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="money" name="money" class="form-control"
                                           onchange="moneyChickValue(this)"  placeholder="贷款金额">
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>利息</label>
                                        <input id="accrual" name="accrual" class="form-control"
                                               placeholder="利息">
                                    </div>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("daikuan/" + urlParam, "POST", data, (res) => {
                if(res.code == 0
        )
            {
